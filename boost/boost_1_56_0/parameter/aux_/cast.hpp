...
#  include <boost_1_56_0/type_traits/remove_const.hpp>
# endif
...
struct cast<void(T), Args>
{
    ...
    typedef typename boost_1_56_0::add_reference<
        typename boost_1_56_0::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    boost_1_56_0::parameter::aux::cast<void predicate, args>::remove_const( \
        boost_1_56_0::parameter::aux::cast<void predicate, args>::execute(value) \
    )
