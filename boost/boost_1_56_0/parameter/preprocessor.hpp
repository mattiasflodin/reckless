...
# include <boost_1_56_0/parameter/parameters.hpp>
# include <boost_1_56_0/parameter/binding.hpp>
# include <boost_1_56_0/parameter/match.hpp>

# include <boost_1_56_0/parameter/aux_/parenthesized_type.hpp>
# include <boost_1_56_0/parameter/aux_/cast.hpp>
# include <boost_1_56_0/parameter/aux_/preprocessor/flatten.hpp>

# include <boost_1_56_0/preprocessor/repetition/repeat_from_to.hpp>
# include <boost_1_56_0/preprocessor/comparison/equal.hpp>
# include <boost_1_56_0/preprocessor/control/if.hpp>
# include <boost_1_56_0/preprocessor/control/iif.hpp>
# include <boost_1_56_0/preprocessor/control/expr_if.hpp>
# include <boost_1_56_0/preprocessor/repetition/enum_params.hpp>
# include <boost_1_56_0/preprocessor/repetition/enum_binary_params.hpp>
# include <boost_1_56_0/preprocessor/repetition/enum_trailing.hpp>
# include <boost_1_56_0/preprocessor/seq/first_n.hpp>
# include <boost_1_56_0/preprocessor/seq/for_each_product.hpp>
# include <boost_1_56_0/preprocessor/seq/for_each_i.hpp> 
# include <boost_1_56_0/preprocessor/tuple/elem.hpp> 
# include <boost_1_56_0/preprocessor/tuple/eat.hpp>
# include <boost_1_56_0/preprocessor/seq/fold_left.hpp>
# include <boost_1_56_0/preprocessor/seq/push_back.hpp>
# include <boost_1_56_0/preprocessor/seq/size.hpp>
# include <boost_1_56_0/preprocessor/seq/enum.hpp>
# include <boost_1_56_0/preprocessor/seq/push_back.hpp>

# include <boost_1_56_0/preprocessor/detail/is_nullary.hpp>

# include <boost_1_56_0/mpl/always.hpp>
# include <boost_1_56_0/mpl/apply_wrap.hpp>

# if BOOST_WORKAROUND(BOOST_MSVC, <= 1300)
#  include <boost_1_56_0/type.hpp>
# endif
...
template <
  ...
  , BOOST_PP_ENUM_BINARY_PARAMS(
        BOOST_PARAMETER_MAX_ARITY, class A, = boost_1_56_0::parameter::void_ BOOST_PP_INTERCEPT
    )
>
struct match
...
template <class T>
msvc_store_type<boost_1_56_0::is_convertible<mpl::_,T>,void*(*)(void*(T))>
msvc_store_predicate_type(void*(*)(void*(T)));
...
struct funptr_predicate
{
    ...
    struct apply
    {
        BOOST_STATIC_CONSTANT(bool, result = 
            sizeof(check_predicate(boost_1_56_0::type<T>(), (Args*)0, &p)) == 1
        );
...
#  define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n) \
    , typename boost_1_56_0::parameter::aux::match< \
...
# define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    ...
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        BOOST_PP_EXPR_IF(n, typename) \
        boost_1_56_0::parameter::aux::argument_pack< \
...
// Builds boost_1_56_0::parameter::parameters<> specialization
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_optional(tag) \
    optional<boost_1_56_0::parameter::deduced<tag>

#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_required(tag) \
    required<boost_1_56_0::parameter::deduced<tag>
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    BOOST_PP_COMMA_IF(i) \
    boost_1_56_0::parameter::BOOST_PP_CAT( \
      ...
      , typename boost_1_56_0::parameter::aux::unwrap_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    boost_1_56_0::parameter::BOOST_PP_CAT( \
      ...
      , boost_1_56_0::parameter::aux::funptr_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    boost_1_56_0::parameter::BOOST_PP_CAT( \
      ...
      , boost_1_56_0::mpl::always<boost_1_56_0::mpl::true_> \
    >
# endif
...
# define BOOST_PARAMETER_FUNCTION_PARAMETERS(tag_namespace, base, args)             \
    ...
    ) : boost_1_56_0::parameter::parameters<                                               \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(arg, tag_namespace) \
    boost_1_56_0::parameter::keyword< \
        tag_namespace::BOOST_PARAMETER_FN_ARG_KEYWORD(arg) \
    >::instance | boost_1_56_0::parameter::aux::use_default_tag()
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(arg) \
    BOOST_PARAMETER_FUNCTION_CAST( \
        boost_1_56_0::parameter::aux::as_lvalue(BOOST_PARAMETER_FN_ARG_DEFAULT(arg), 0L) \
      , BOOST_PARAMETER_FN_ARG_PRED(arg) \
      , Args \
    )
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY(name, n, split_args, tag_ns, const_) \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)( \
      ...
      , boost_1_56_0::parameter::aux::use_default_tag \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG(r, tag_ns, arg) \
    , BOOST_PARAMETER_FUNCTION_CAST( \
          args[ \
              boost_1_56_0::parameter::keyword<tag_ns::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance \
          ] \
        , BOOST_PARAMETER_FN_ARG_PRED(arg) \
        , Args \
      )
