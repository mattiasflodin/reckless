...
#include <boost_1_56_0/mpl/aux_/type_wrapper.hpp>
#include <boost_1_56_0/mpl/aux_/yes_no.hpp>
#include <boost_1_56_0/mpl/aux_/config/gcc.hpp>
#include <boost_1_56_0/mpl/aux_/config/has_xxx.hpp>
#include <boost_1_56_0/mpl/aux_/config/msvc_typename.hpp>
...
#include <boost_1_56_0/preprocessor/array/elem.hpp>
...
#include <boost_1_56_0/preprocessor/repetition/enum_trailing_params.hpp>

#if BOOST_WORKAROUND( __BORLANDC__, BOOST_TESTED_AT(0x590) )
# include <boost_1_56_0/type_traits/is_class.hpp>
#endif
...
namespace boost_1_56_0 { namespace mpl { namespace aux {
...
template< typename T, typename name = ::boost_1_56_0::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static boost_1_56_0::mpl::aux::no_tag \
    test(void(*)(::boost_1_56_0::mpl::aux::has_xxx_tag)); \
    \
    static boost_1_56_0::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(boost_1_56_0::mpl::aux::no_tag) \
        ); \
    typedef boost_1_56_0::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = boost_1_56_0::mpl::bool_<default_> > \
struct trait \
    : boost_1_56_0::mpl::if_c< \
          boost_1_56_0::mpl::aux::msvc_is_incomplete<T>::value \
        , boost_1_56_0::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef boost_1_56_0::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( boost_1_56_0::mpl::aux::type_wrapper<U> const volatile * \
                           , boost_1_56_0::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef boost_1_56_0::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = boost_1_56_0::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, boost_1_56_0::is_class< T >::value >::value) );     \
    typedef boost_1_56_0::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static boost_1_56_0::mpl::aux::yes_tag test( \
              boost_1_56_0::mpl::aux::type_wrapper<U> const volatile* \
            , boost_1_56_0::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static boost_1_56_0::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef boost_1_56_0::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(boost_1_56_0::mpl::aux::yes_tag) \
        ); \
    typedef boost_1_56_0::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static boost_1_56_0::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            boost_1_56_0::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< boost_1_56_0::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(boost_1_56_0::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = boost_1_56_0::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = boost_1_56_0::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
