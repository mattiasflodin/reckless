...
#   endif
#   else
#       include <boost_1_56_0/mpl/aux_/has_rebind.hpp>
#   endif
#endif
...
#   include <boost_1_56_0/mpl/aux_/preprocessor/range.hpp>
...
#   define BOOST_PP_FILENAME_1 <boost_1_56_0/mpl/aux_/template_arity.hpp>
...
{
    BOOST_STATIC_CONSTANT(int, value = 
          sizeof(::boost_1_56_0::mpl::aux::arity_helper(type_wrapper<F>(),arity_tag<N>())) - 1
        );
};
...
#   include <boost_1_56_0/mpl/aux_/config/eti.hpp>
...
template< typename F >
struct template_arity
    : template_arity_impl< ::boost_1_56_0::mpl::aux::has_rebind<F>::value >
        ::template result_<F>
{
};
