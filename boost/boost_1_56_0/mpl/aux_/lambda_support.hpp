...
#   include <boost_1_56_0/mpl/aux_/na_fwd.hpp>
...
#   include <boost_1_56_0/preprocessor/tuple/to_list.hpp>
#   include <boost_1_56_0/preprocessor/list/for_each_i.hpp>
...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::boost_1_56_0::mpl::aux::yes_tag operator|( \
      ::boost_1_56_0::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::boost_1_56_0::mpl::aux::no_tag operator|( \
      ::boost_1_56_0::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::boost_1_56_0::mpl::na) >* \
    ); \
/**/
...
::boost_1_56_0::mpl::aux::yes_tag operator|( \
      ::boost_1_56_0::mpl::aux::has_rebind_tag<int> \
    , ::boost_1_56_0::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
