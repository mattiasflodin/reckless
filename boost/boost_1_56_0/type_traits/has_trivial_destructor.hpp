...
#else
   BOOST_STATIC_CONSTANT(bool, value = ::boost_1_56_0::is_pod<T>::value);
#endif
};

} // namespace detail

BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_destructor,T,::boost_1_56_0::detail::has_trivial_dtor_impl<T>::value)
