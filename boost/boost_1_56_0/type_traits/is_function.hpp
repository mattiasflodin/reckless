...
#   include <boost_1_56_0/type_traits/detail/is_function_ptr_helper.hpp>
#else
#   include <boost_1_56_0/type_traits/detail/is_function_ptr_tester.hpp>
...
struct is_function_chooser<false>
{
    template< typename T > struct result_
        : public ::boost_1_56_0::type_traits::is_function_ptr_helper<T*>
    {
    };
};
...
struct is_function_impl
    : public is_function_chooser< ::boost_1_56_0::is_reference<T>::value >
...
#pragma warning(disable:6334)
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(::boost_1_56_0::type_traits::is_function_ptr_tester(t))
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_function,T,::boost_1_56_0::detail::is_function_impl<T>::value)
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
