...
#include <boost_1_56_0/type_traits/is_polymorphic.hpp>
#endif
#endif
...
struct is_abstract_imp
{
   typedef is_abstract_select< ::boost_1_56_0::is_class<T>::value> selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::boost_1_56_0::detail::is_abstract_imp<T>::value)
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::boost_1_56_0::detail::is_polymorphic_imp<T>::value)
#endif
