...
{
    typedef boost_1_56_0::uint8_t type;
};

template< >
struct make_storage_type< 1u, true >
{
    typedef boost_1_56_0::int8_t type;
};

template< >
struct make_storage_type< 2u, false >
{
    typedef boost_1_56_0::uint16_t type;
};

template< >
struct make_storage_type< 2u, true >
{
    typedef boost_1_56_0::int16_t type;
};

template< >
struct make_storage_type< 4u, false >
{
    typedef boost_1_56_0::uint32_t type;
};

template< >
struct make_storage_type< 4u, true >
{
    typedef boost_1_56_0::int32_t type;
};

template< >
struct make_storage_type< 8u, false >
{
    typedef boost_1_56_0::uint64_t type;
};

template< >
struct make_storage_type< 8u, true >
{
    typedef boost_1_56_0::int64_t type;
};
...
{
    typedef boost_1_56_0::uint128_type type;
};

template< >
struct make_storage_type< 16u, true >
{
    typedef boost_1_56_0::int128_type type;
};
