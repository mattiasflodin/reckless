...
struct tr1_result_of<F(BOOST_RESULT_OF_ARGS)>
    : mpl::if_<
        ...
        , boost_1_56_0::detail::tr1_result_of_impl<
            typename remove_cv<F>::type,
            typename remove_cv<F>::type(BOOST_RESULT_OF_ARGS),
            (boost_1_56_0::detail::has_result_type<F>::value)>
        , boost_1_56_0::detail::tr1_result_of_impl<
            F,
            F(BOOST_RESULT_OF_ARGS),
            (boost_1_56_0::detail::has_result_type<F>::value)> >::type { };
#endif
...
struct BOOST_PP_CAT(result_of_is_callable_, BOOST_PP_ITERATION()) {
    ...
    static const bool value = (
        sizeof(result_of_no_type) == sizeof(detail::result_of_is_private_type(
            (boost_1_56_0::declval<wrapper_t>()(BOOST_PP_ENUM_BINARY_PARAMS(BOOST_PP_ITERATION(), boost_1_56_0::declval<T, >() BOOST_PP_INTERCEPT)), result_of_weird_type())
        ))
    );
...
{
  typedef decltype(
    boost_1_56_0::declval<F>()(
      BOOST_PP_ENUM_BINARY_PARAMS(BOOST_PP_ITERATION(), boost_1_56_0::declval<T, >() BOOST_PP_INTERCEPT)
    )
  ) type;
};
