...
#include <boost_1_56_0/assert.hpp>
#include <boost_1_56_0/static_assert.hpp>
#include <boost_1_56_0/type_traits/has_trivial_assign.hpp>
#include <boost_1_56_0/type_traits/has_trivial_destructor.hpp>

#include <boost_1_56_0/lockfree/detail/atomic.hpp>
#include <boost_1_56_0/lockfree/detail/copy_payload.hpp>
#include <boost_1_56_0/lockfree/detail/freelist.hpp>
#include <boost_1_56_0/lockfree/detail/parameter.hpp>
#include <boost_1_56_0/lockfree/detail/tagged_ptr.hpp>
...
typedef parameter::parameters<boost_1_56_0::parameter::optional<tag::allocator>,
                              boost_1_56_0::parameter::optional<tag::capacity>
                             > queue_signature;
 ...
 *
 *  \b Policies:
 *  - \ref boost_1_56_0::lockfree::fixed_sized, defaults to \c boost_1_56_0::lockfree::fixed_sized<false> \n
 ...
 *
 *  - \ref boost_1_56_0::lockfree::capacity, optional \n
 ...
 *
 *  - \ref boost_1_56_0::lockfree::allocator, defaults to \c boost_1_56_0::lockfree::allocator<std::allocator<void>> \n
...
template <typename T,
          class A0 = boost_1_56_0::parameter::void_,
          class A1 = boost_1_56_0::parameter::void_,
          class A2 = boost_1_56_0::parameter::void_>
#else
...
private:
    ...
    BOOST_STATIC_ASSERT((boost_1_56_0::has_trivial_destructor<T>::value));
#endif

#ifdef BOOST_HAS_TRIVIAL_ASSIGN
    BOOST_STATIC_ASSERT((boost_1_56_0::has_trivial_assign<T>::value));
#endif
...
public:
    ...
    /** \copydoc boost_1_56_0::lockfree::stack::reserve
     * */
    ...
    /** \copydoc boost_1_56_0::lockfree::stack::reserve_unsafe
     * */
...
public:
    ...
    /// \copydoc boost_1_56_0::lockfree::queue::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc boost_1_56_0::lockfree::queue::consume_all(Functor & rhs)
    template <typename Functor>
