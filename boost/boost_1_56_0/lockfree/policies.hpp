...
#include <boost_1_56_0/parameter.hpp>
#include <boost_1_56_0/mpl/bool.hpp>
#include <boost_1_56_0/mpl/size_t.hpp>
...
struct fixed_sized:
    boost_1_56_0::parameter::template_keyword<tag::fixed_sized, boost_1_56_0::mpl::bool_<IsFixedSized> >
{};
...
struct capacity:
    boost_1_56_0::parameter::template_keyword<tag::capacity, boost_1_56_0::mpl::size_t<Size> >
{};
...
struct allocator:
    boost_1_56_0::parameter::template_keyword<tag::allocator, Alloc>
{};
