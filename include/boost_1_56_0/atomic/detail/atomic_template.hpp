...
#include <cstddef>
#include <boost_1_56_0/cstdint.hpp>
#include <boost_1_56_0/assert.hpp>
#include <boost_1_56_0/type_traits/is_signed.hpp>
#include <boost_1_56_0/type_traits/is_integral.hpp>
#include <boost_1_56_0/atomic/detail/config.hpp>
#include <boost_1_56_0/atomic/detail/casts.hpp>
#include <boost_1_56_0/atomic/detail/operations_fwd.hpp>
...
#pragma warning(push)
// 'boost_1_56_0::atomics::atomic<T>' : multiple assignment operators specified
...
template< typename T, bool IsInt = boost_1_56_0::is_integral< T >::value >
struct classify
{
    typedef void type;
};
...
private:
    ...
    typedef atomics::detail::operations< storage_size_of< value_type >::value, boost_1_56_0::is_signed< T >::value > operations;
...
typedef atomic< boost_1_56_0::ulong_long_type > atomic_ullong;
typedef atomic< boost_1_56_0::long_long_type > atomic_llong;
#endif
