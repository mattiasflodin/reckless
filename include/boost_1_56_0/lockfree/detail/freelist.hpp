...
#include <boost_1_56_0/array.hpp>
#include <boost_1_56_0/config.hpp>
#include <boost_1_56_0/cstdint.hpp>
#include <boost_1_56_0/noncopyable.hpp>
...
{
public:
    typedef boost_1_56_0::uint16_t tag_t;
    typedef boost_1_56_0::uint16_t index_t;
...
struct compiletime_sized_freelist_storage
{
    ...
    boost_1_56_0::array<char, size * sizeof(T)> data;
    ...
    Alloc
{
    ...
    {
        if (count > 65535)
            boost_1_56_0::throw_exception(std::runtime_error("boost.lockfree: freelist size is limited to a maximum of 65535 objects"));
