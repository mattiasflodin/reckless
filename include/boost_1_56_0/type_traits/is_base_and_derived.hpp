...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::boost_1_56_0::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::boost_1_56_0::is_class<B>::value,
       ::boost_1_56_0::is_class<D>::value,
       ::boost_1_56_0::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::boost_1_56_0::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::boost_1_56_0::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
