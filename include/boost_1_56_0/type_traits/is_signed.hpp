...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::boost_1_56_0::detail::is_signed_values<T>::minus_one  > boost_1_56_0::detail::is_signed_values<T>::zero)));
};
...
struct is_signed_imp
{
   typedef is_signed_select_helper< 
      ::boost_1_56_0::type_traits::ice_or<
         ...
         ::boost_1_56_0::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::boost_1_56_0::detail::is_signed_imp<T>::value)
#endif
