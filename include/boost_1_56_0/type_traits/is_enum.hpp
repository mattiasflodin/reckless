...
#include <boost_1_56_0/type_traits/add_reference.hpp>
...
struct is_class_or_union
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::boost_1_56_0::type_traits::ice_or<
           ::boost_1_56_0::is_class<T>::value
         , ::boost_1_56_0::is_union<T>::value
      >::value));
};
...
# else
    template <class U> static ::boost_1_56_0::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::boost_1_56_0::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::boost_1_56_0::type_traits::yes_type));
#  else
    template <class U>
    static ::boost_1_56_0::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::boost_1_56_0::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::boost_1_56_0::is_convertible<typename boost_1_56_0::add_reference<T>::type,::boost_1_56_0::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::boost_1_56_0::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::boost_1_56_0::type_traits::ice_or<
         ...
         , ::boost_1_56_0::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::boost_1_56_0::detail::is_enum_helper<
          ::boost_1_56_0::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::boost_1_56_0::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::boost_1_56_0::detail::is_enum_impl<T>::value)
